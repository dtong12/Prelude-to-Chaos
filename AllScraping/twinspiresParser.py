from twinspiresCurrentEvents import *
import re
...
def test_full_code(type):
    ...
    if type == 'local':
        ...
        res = async_twinspires_main() #betrivers_main()
    ...
    for test_event in json_res:
        try:
            ingested_betrivers = BarstoolsGameState(json_res[test_event])
